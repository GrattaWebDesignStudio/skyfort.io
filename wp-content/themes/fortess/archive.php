...
<?php get_header(); ?>
			...
			<div class="content-main">
				...
				<div class="container">
					<div class="mb-60">
						<div class="text-styled"><?php echo get_field('post-category-title2', 'category_'.get_queried_object()->term_id);?></div>

						<?php
					       the_archive_title( '<h1 class="heading-lg">', '</h1>' );
			        	?>

						<div class="max-w color-opacity">
						      <?php echo  apply_filters( 'the_content', get_queried_object()->category_description); ?>
						</div>
					</div>
<?php endif; ?>                    
                    <?php if ( have_posts() ) : ?>
