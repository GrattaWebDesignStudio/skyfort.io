jQuery(document).ready(function () {
    ...
    jQuery(document).on("click", 'form#forgot_password_confirm_form button[type="submit"]', function (event) { 
    ...
    jQuery(document).on("click", 'form#forgot_password_form button[type="submit"]', function (event) { 
                ...
                jQuery.ajax({
			                 ...
			                 success: function( data ) {
                                            ...
                                            if (data.status) {
                                                ...
                                                jQuery('#modal-resetpassword-complete').show();
